/*
 * JTATransactionFactory.java	2005-7-17
 *
...
public class JTATransactionFactory implements TransactionFactory {
	...
	/**
	 * 工厂构造方法，创建JTATransactionFactory的实例
	 * 
	 * @param resManager 资源管理器
	 * @param config JThink配置信息
	 */
	public 	JTATransactionFactory(ResourceManager resManager, Configuration config, Element trsctnConfig){
	...
	/**
	 * 创建并返回JTATransaction的实例
	 * 
	 * @return 返回接口Transaction的实现
	 */
	public Transaction create() {
		// TODO 自动生成方法存根
		return new JTATransaction(resManager, dataSourceConfigEL, trsctnConfig);
	}
