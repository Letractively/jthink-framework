...
/*
 * HsqlSQLBuilder.java	2008-10-28
 *
...
/**
 * 构建SQL，针对Hsql数据库。 此类型扩展了SQLBuilder类型，并覆盖了constructSQLForSelect()方法，
 * 以便构建具有分页功能的SQL语句。
 * 
 * <p><pre><b>
 * 历史更新记录:</b>
 ...
 * 
 */
public class HsqlSQLBuilder extends SQLBuilder{
  ...
  public SQL constructSQLForSelect(String tableName,
    ...
    /* 生成SQL查询串 */
    String sqlStr = "SELECT " + limitStr + distinctStr +  columnNamesStr
        + fromStr
