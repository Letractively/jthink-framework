...
public final class DateTimeHelper {
	 ...
	 * @return 如果为null，返回""
	 */
	public static String formatDateTimetoString(String dateTimeStr, Locale locale) {
	 ...
	 * @return 如果为null，返回""
	 */
	public static String formatDatetoString(String dateStr) {
  ...
  public static Date addTime(Date d, double times, int type) {
	 ...
	 * @return 返回被格式化后的中文字符串,如1999-09-06 返回:一九九九年九月六号
	 */
	public static String formateDateToCNString(String d){
		if (d == null){
			throw new IllegalArgumentException("参数d不能是null对象!");
		}
		String re1 = formatDateTimetoString(d,FMT_MMDDYY_CN,Locale.CHINA);
	 ...
	 * @return 返回被格式化后的中文字符串,如1999-09-06 18:30:20 返回:一九九九年九月六号十八点三十分二十秒
	 */
	public static String formateDateTimeToCNString(String d){
		if(d==null){
