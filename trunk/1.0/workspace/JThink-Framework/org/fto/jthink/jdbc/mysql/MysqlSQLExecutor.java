/*
 * MysqlSQLExecutor.java	2005-7-1
 *
...
/**
 * 此类型的实例负责执行SQL语句，针对Mysql数据库。此类型扩展了SQLExecutor类型，
 ...
 * 
 */
public class MysqlSQLExecutor extends SQLExecutor {
  		
  /**
   * 创建MysqlSQLExecutor的实例
   * 
   * @param transaction JDBC事件
   * @param connId 数据库连接ID 
   */
  public MysqlSQLExecutor(JDBCTransaction transaction, String connId){
