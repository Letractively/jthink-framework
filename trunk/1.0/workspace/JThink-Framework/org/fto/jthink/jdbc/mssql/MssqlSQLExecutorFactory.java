/*
 * MssqlSQLExecutorFactory.java	2005-7-1
 *
...
/**
 * MssqlSQLExecutor工厂，用此工厂创建MssqlSQLExecutor类型的实例。
 * 
 * <p><pre><b>
 * 历史更新记录:</b>
 * 2005-07-01  创建此类型
...
public class MssqlSQLExecutorFactory implements SQLExecutorFactory {
...
//  private ResultMaker mker = null;
   ...
   */
  public MssqlSQLExecutorFactory(JDBCTransaction transaction, String connId){
