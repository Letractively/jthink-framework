...
<% 
	...
	Element revertInfo = mboardJBean.getRevertInfo();
	
	System.out.println("revertInfo:"+revertInfo);
%>
<html>
<head>
...
<form name="form1" method="post" action="?ACTION=EDIT&ID=<%=request.getParameter("ID")%>">
  <table width="100%" border="0" cellspacing="3" cellpadding="2">
    ...
    <tr> 
      ...
      <td height="23"><textarea name="RevertContent" cols="60" rows="5" id="RevertContent"><%=XMLHelper.getAttributeString(revertInfo, "REVERTCONTENT")%></textarea>
        *</td>
    </tr>
    <tr> 
      <td height="23" align="right" bgcolor="#CCCCCC">回复者</td>
      <td height="23"><input name="Reverter" type="text" id="Reverter" size="20" maxlength="20" value="<%=XMLHelper.getAttributeString(revertInfo, "REVERTER")%>">
        * </td>
    </tr>
    <tr> 
