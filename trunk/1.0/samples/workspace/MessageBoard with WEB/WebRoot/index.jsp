...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><%=mboardJBean.getSeqNo(i)%>. <%=HTMLHelper.toHTMLString(message.getAttributeValue("SUBJECT"))%></td>
          <td width="100" align="right"><a href="reverter.jsp?ID=<%=message.getAttributeValue("ID")%>">回复</a>&nbsp;&nbsp;<a href="javascript:deleteMessage(<%=message.getAttributeValue("ID")%>)">删除</a></td>
        </tr>
</table>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#666666">
  <tr> 
    ...
    <td height="50" valign="top" bgcolor="#FFFFFF"><%=HTMLHelper.toHTMLString(message.getAttributeValue("CONTENT"))%></td>
  </tr>
  <tr> 
    <td width="100" height="26" bgcolor="#CCCCCC">&nbsp;</td>
    <td height="26" bgcolor="#CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="160">留言者：<a href="mailto:<%=message.getAttributeValue("EMAIL")%>"><%=HTMLHelper.toHTMLString(message.getAttributeValue("SENDER"))%></a></td>
          <td>时间：<%=DateTimeHelper.formatDateTimetoString(message.getAttributeValue("SENDTIME"))%></td>
          <td width="160">IP：<%=message.getAttributeValue("IP")%></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td width="100" height="50" align="right" bgcolor="#CCCCCC">回复内容</td>
    <td height="50" valign="top" bgcolor="#FFFFFF"><%=HTMLHelper.toHTMLString(message.getAttributeValue("REVERTCONTENT"))%></td>
  </tr>
  <tr> 
    <td width="100" height="26" bgcolor="#CCCCCC">&nbsp;</td>
    <td height="26" bgcolor="#CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="160">回复者：<%=HTMLHelper.toHTMLString(message.getAttributeValue("REVERTER"))%></td>
          <td>时间：<%=DateTimeHelper.formatDateTimetoString(message.getAttributeValue("REVERTTIME"))%></td>
        </tr>
      </table></td>
  </tr>
</table>
